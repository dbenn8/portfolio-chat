...
def test_build_context_includes_source_tags():
    ...
    results = [
        {"text": "Dan built MARVIN", "metadata": {"project": "MARVIN", "source": "summary.md", "section": "Overview", "content_type": "summary", "slug": ""}},
        {"text": "n8n workflows for MBO", "metadata": {"project": "MBO Listing Sync", "source": "mbo-listing-sync.astro", "section": "Approach", "content_type": "portfolio", "slug": "/projects/mbo-listing-sync"}},
    ]
...
def test_build_source_links_deduplicates():
    ...
    results = [
        {"metadata": {"project": "MARVIN", "source": "summary.md", "slug": ""}},
        {"metadata": {"project": "MBO Listing Sync", "source": "mbo-listing-sync.astro", "slug": "/projects/mbo-listing-sync"}},
        {"metadata": {"project": "MBO Listing Sync", "source": "mbo-listing-sync.astro", "slug": "/projects/mbo-listing-sync"}},
    ]
